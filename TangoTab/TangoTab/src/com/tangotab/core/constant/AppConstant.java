...
/**
 * This class will contain all the constant informations which will be used through out the application.
 * 
 * @author dillip.lenka
 * 
 */
public class AppConstant {
	...
	public static String DEEP_LINK_DEAL_DETAILS = "/deals/get?dealId=%@ &date=%@ &coordinate=%@";
	...
	public static String baseUrl = productionServer;
	...
	public static boolean IS_CLAIM_OFFER_PAGE =false;
	public static int SELECTED_POSITION = 0;

	//public static final String NEAR_TO_RESTRURANT = "50.0";
	public static final String NEAR_TO_RESTRURANT = "0.186411";//300 meter in miles
	...
	public static String MYPHILANTHROPY_METRICS_URL_LIVE="http://facebook.tangotab.com/json/metrics/";

	/**
	 * Constant added for Contact Support.
	 */
	public static final String SUPPORT_EMAIL_ID = "support@tangotab.com";
	public static final String EMAIL_SUBJECT = "Android App Support - Version";
	public static final int TIME_PEROID = 30000;

	/**
	 * constant added for Push notification
	 */
	public static final String NOTIFICATION_URL = "http://172.16.76.48:8080/gcm-demo/register?regId=";
	...
	public static final int CLAIM_TWEET_SENT = 1234;
	public static final int SHARE_COMMON_DIALOG = 1987;
	public static final String NEARME_PAGE_STATE = "nearmepagestate";
	public static final String OFFER_DETAIL = "offerdetails";
	public static final String VERSION_PREFERENCES = "versionpreferences";
	
	// constant for FB signUP
	public static final String ZIP_CODE_WORK = "zip_code_work";
	public static final String PROMO_CODE = "promo_code";
	public static final String DEEPLINK_KEY = "deeplink_key";
	public static final String OBJECT_KEY = "object_key";
	
	// constant added for search 
	public static String SEARCH_MAX_TIME_RANGE;
	public static String ISCOORDINATES_REQUESTED="iscoordinatesrequested";
	
	public static String ENABLE_GPS_DIALOG="enablegpsdialog";
	public static String ENABLE_GPS_KEY="gpskey";
