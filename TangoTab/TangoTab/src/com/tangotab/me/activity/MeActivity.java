			...
			protected Integer doInBackground(Void... params) {
				try {
					...
					//String fileName = "android.resource://" + MeActivity.this.getPackageName() + "/drawable/tangotab_icon";
     				...
     				String toPost="I've fed "+me+" people in need just by dining out with TangoTab. " +
     						"It's a free app to get free restaurant deals. http://apps.tangotab.com";
	...
	if(msg.what==TWITTER_FAILED){
	 ...
	 private void publishMessage() {
		 ...
		 //String url="https://fbcdn-photos-f-a.akamaihd.net/hphotos-ak-prn1/851561_358228107610729_1599010098_n.gif";
			...
			String tangotab = sharPreferences.getString("tangotabPhil", "0");
			String philonThrophy=createPhilontrophyFormatString(tangotab);
			facebookFacade.publishMessage("I've fed "+me+" people in need just by dining out with TangoTab."+
			" So far TangoTab has donated over "
					+philonThrophy
			+" meals to people in need. TangoTab offers you  free restaurant deals. This is definitely an app you want on your phone! http://apps.tangotab.com.",
					null,
					null,
					null,
					null);
