...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	public Request(int method, String url, Response.ErrorListener listener) {
		...
		mDefaultTrafficStatsTag = (TextUtils.isEmpty(url) || url == null || Uri.parse(url).getHost() == null) ? 0 : Uri
				.parse(url).getHost().hashCode();
	}
	...
	/**
	 * Sets the list of extra HTTP headers to go along with this request.
	 * 
	 * @param headers
	 *            - the mapping of headers to send along with this request
	 */
