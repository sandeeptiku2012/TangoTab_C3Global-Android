...
import com.tangotab.signUp.activity.AboutUsActivity;
...
public class MainMenuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (ValidationUtil.isNullOrEmpty(alternateZipCode)
			...
			alternateButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent alternateIntent = new Intent(MainMenuActivity.this, AlternateLocationActivity.class);

					alternateIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					alternateIntent.putExtra("SearchBy", "alternateZipCode");
					alternateIntent.putExtra("alternateZipCode", alternateZipCode);
		...
		nearMe.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (AppConstant.IS_CLAIM_OFFER_PAGE) {
					...
					Intent calimedIntent = new Intent(MainMenuActivity.this, ClaimOfferActivity.class);
		...
		/**
		 * About us onclick listener
		 */
		aboutUsButton.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Intent privacy = new Intent(getApplicationContext(), AboutUsActivity.class);
				startActivity(privacy);
			}
		});
